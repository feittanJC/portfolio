...
export default function HabilidadesIcon({text,img}) {
  return (
    <section className='flex items-center px-4 py-2 mx-4 bg-white rounded-xl hover:shadow-red-500/50 hover:shadow-lg hover:-translate-y-4 ease-in duration-100 '>
